package com.happytails.app.modules.pushnotification.`data`.model
...
data class PushNotificationModel(
   ...
   * TODO Replace with dynamic value
   */
  var txtHappyTails: String? = MyApp.getInstance().resources.getString(R.string.lbl_happy_tails)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtDistance: String? = MyApp.getInstance().resources.getString(R.string.lbl_15m_ago)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtSubheadline: String? = MyApp.getInstance().resources.getString(R.string.msg_bella_s_vitals)
  ,
  /**
   * TODO Replace with dynamic value
   */
